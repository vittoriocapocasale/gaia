...
replace (
	...
	// Cosmos SDK & IBC
	github.com/cosmos/cosmos-sdk => github.com/vittoriocapocasale/cosmos-sdk v0.45.013
	...
	// Tendermint
	github.com/tendermint/tendermint => github.com/vittoriocapocasale/tendermint v0.34.27
